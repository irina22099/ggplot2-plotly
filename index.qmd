...
# Grafico de dispersion de de cilindros vs rendimineto en ciudad
# y que muestre la varible de tipo de cobustible (fl)
```
...
# Variables adicionales - tamaño
mpg |>
  ggplot(aes(x = displ, y = hwy , size = cyl)) +
  geom_point()

# Variables adicionales - forma
mpg |>
  ggplot(aes(x = displ, y = hwy , shape = class)) +
  geom_point()
